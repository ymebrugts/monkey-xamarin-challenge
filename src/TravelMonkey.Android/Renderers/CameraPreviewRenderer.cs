...
using TravelMonkey.Views.CustomRenderers;
using TravelMonkey.Droid.Camera2Basic;
using TravelMonkey.Droid.Camera2Basic.Listeners;
using TravelMonkey.Services;
using TravelMonkey.Droid.Renderers;

[assembly: ExportRenderer(typeof(CameraPreview), typeof(CameraPreviewRenderer))]
namespace TravelMonkey.Droid.Renderers
{
	public class CameraPreviewRenderer : ViewRenderer<CameraPreview, FrameLayout>, ICamera2Basic
	{
		...
		//frame layout for wrapping a disproportionate texture view (overflow)
		private FrameLayout frameLayout;

		//texture where the camera preview is drawed on
		private AutoFitTextureView autoFitTextureView;

		//callback function
		public Action Detect { get; set; }
